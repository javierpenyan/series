...
require_once "../funciones/funciones.php";
    ...
    <div class='row gy-0 my-0' id='centrar'>
        ...
        echo"
        <form action = '../controladores/controlador_plataformas_realizar_modificado.php' method = 'post' enctype = 'multipart/form-data'>
        <div>
           <input type='hidden' value = '". $plataforma["id2"] ."' class='form-control'  name='id'>
         </div>
         <div class='form-floating mb-3'>
           <input type='text' value = '". $plataforma["nombre"] ."' class='form-control' id='nombre' placeholder='nombre' name='nombre' required>
